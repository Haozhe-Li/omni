...
supervisor_agent = create_react_agent(
    ...
    prompt=(
        ...
        "- **BUDGET AWARENESS** - Never exceed 8 agent calls (summarizing_agent is FREE)\n"
        "- **MANDATORY COMPLETION** - If you reach 8 calls, you MUST call summarizing_agent immediately\n"
        "- **Math Tasks** - ALWAYS use math_agent for calculations, NEVER coding_agent for math\n"
        "- **Coding Agent Restriction** - Only use when explicitly assigned programming tasks, not for calculations\n"
        ...
        "- **Final synthesis** - Always end with summarizing_agent (FREE - doesn't count toward 8-call limit)\n"
        ...
        "- How many calls have I made? (Stay under 8, summarizing_agent is FREE)\n"
        "- Is this a math calculation? → Use math_agent, NOT coding_agent\n"
        "- Is this a programming task explicitly assigned by user? → Use coding_agent\n"
